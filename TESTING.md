...
Thank you for your interest in improving Aura software prior to its next release. Your bug reports increase the quality of the Aura experience for thousands of people around the world using Aura. 

New bug reports benefiting the next release will be documented in the release notes to recognize your unique contribution in the history of the Aura open source project.

To contribute to the process of testing the Aura Desktop App:
...
2. Install the latest Aura Desktop App
 - Download the latest pre-release Aura Desktop App from the [GitHub Releases page](https://github.com/mattermost/desktop/releases).
 ...
 - Select "Save" and log in to Aura.

3. Go to the [Public Test Channel](https://community.mattermost.com/core/channels/public-test-channel) and try the following:
 - Post a message with information on what you're testing, for example: `Testing Aura Desktop App 5.0.2 on Windows 10 64-bit`.
...
4. For any bugs found, please [file a new issue report for each](https://github.com/mattermost/desktop/issues/new).
 - Please include:
    - Operating System
    - Aura Desktop App version (See File Menu > Help > Version Number) 
    - Aura Server version (See Aura Menu > About Aura, where Aura Menu can be accessed by clicking on three dots next to your profile name) 
