...
contextBridge.exposeInMainWorld('desktop', {
	...
	unmaximizeWindow: () => ipcRenderer.send(WINDOW_UNMAXIMIZE),
	closeWindow: () => ipcRenderer.send(WINDOW_CLOSE),
	isWindowMaximized: () => ipcRenderer.invoke(IS_WINDOW_MAXIMIZED),
	...
	openWindowsFilesystemPreferences: () => ipcRenderer.send(OPEN_WINDOWS_FILESYSTEM_PREFERENCES),
	openMacOSScreenRecordingPreferences: () => ipcRenderer.send(OPEN_MACOS_SCREEN_RECORDING_PREFERENCES),
	getMediaAccessStatus: (mediaType) => ipcRenderer.invoke(GET_MEDIA_ACCESS_STATUS, mediaType),
	resetPermission: (origin, permission) => ipcRenderer.invoke(RESET_PERMISSION, origin, permission),
